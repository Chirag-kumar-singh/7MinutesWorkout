...
/**
 * Constants Class where you can add the constant values of the project.
 */

//TODO(5.3 - Making a default list of exercise in the Constant file along with the name image using the Model Class which later on will be used to show in the UI.)
...
class Constants {
    companion object{
        ...
        /**
         * Here we are adding all exercise to a single list with all the default values.
         */
        ...
        fun defaultExerciseList(): ArrayList<ExerciseModel> {
            ...
            val tricepDepOnChair = ExerciseModel(7, "Tricep Dip On Chair", R.drawable.ic_triceps_dip_on_chair, false, false)
            exerciseList.add(tricepDepOnChair)
            ...
            val pushupAndRoatation = ExerciseModel(11, "Push up and Rotation", R.drawable.ic_push_up_and_rotation, false, false)
            exerciseList.add(pushupAndRoatation)
